<template>
  <div class="wish-sent-page min-h-dvh px-4 pb-24 pt-8 relative z-10">
    <header class="flex items-center gap-3 mb-6">
      ...
      <h1 class="text-xl font-semibold text-text-primary">我发出的</h1>
    </header>
...
const filters = [
  ...
  { value: 'rejected', label: '被婉拒' },
  { value: 'done', label: '已完成' },
]

const filteredWishes = computed(() => {
  const all = wishesStore.wishes.filter(w => w.author === auth.identity)
